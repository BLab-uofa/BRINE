...
from smac.acquisition.function import LCB, EI
...
class SMAC3():
    ...
    def run_smac(self):
        ...
        if row_count % 3 == 0:
            acq = EI(xi=0)
            print("acq ALERT: Balancing explore-exploit...")
        else:
            acq = LCB(beta=2)
            print("acq ALERT: Harsh Explore...")
        ...
        smac = HyperparameterOptimizationFacade(
            scenario=scenario,
            target_function=self.objective_function,   # penalty time!
